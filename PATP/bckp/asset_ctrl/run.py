...
from PyQt5.QtWidgets import QMainWindow, QApplication, QPushButton, QFrame,QWidget, QLabel, QGraphicsDropShadowEffect, QListWidget, QTableWidget, QListView,QTableView, QAbstractItemView, QHeaderView, QTextBrowser, QComboBox
...
class interface(QMainWindow):
    ...
    def handle_row_click(self, index):
        ...
        for column in range(self.table_view.model().columnCount()):
            ...
            print(f"{self.table_view.model()}: {data}")
